...
LDLIBSOPTIONS=`pkg-config --libs zlib` -lhdf5.dll -lhdf5_cpp.dll `pkg-config --libs matio` `pkg-config --libs expat` -Wl,-rpath,'../libtdms/dist/Release_cygwin/GNU-Linux' -L../libtdms/dist/Release_cygwin/GNU-Linux -ltdms  
