...
LDLIBSOPTIONS=`pkg-config --libs zlib` /usr/lib/i386-linux-gnu/libsz.so /usr/lib/i386-linux-gnu/hdf5/serial/libhdf5.so /usr/lib/i386-linux-gnu/hdf5/serial/libhdf5_cpp.so  

# Build Targets
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/formatconverter

${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/formatconverter: /usr/lib/i386-linux-gnu/libsz.so

${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/formatconverter: /usr/lib/i386-linux-gnu/hdf5/serial/libhdf5.so

${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/formatconverter: /usr/lib/i386-linux-gnu/hdf5/serial/libhdf5_cpp.so
